...
/// Referring to the C++ portion of the game object (as opposed to the C# game object).
///
...
impl CppGameObject {
    /// Iterates over the Components attached to this game object.
    pub fn components<'a>(
        &'a self,
        process: &'a Process,
    ...
    /// Tries to find the base address of a Component (e.g. MonoBehaviour) attached to this game
    /// object.
